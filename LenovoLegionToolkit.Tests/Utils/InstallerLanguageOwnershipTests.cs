...
public class InstallerLanguageOwnershipTests
{
    ...
    {
        var appStartup = ReadRepositoryFile("LenovoLegionToolkit.WPF", "App.xaml.cs");
        var localizationHelper = ReadRepositoryFile("LenovoLegionToolkit.WPF", "Utils", "LocalizationHelper.cs");
        var languageWindow = ReadRepositoryFile("LenovoLegionToolkit.WPF", "Windows", "Utils", "LanguageSelectorWindow.xaml.cs");
        ...
        localizationHelper.Should().Contain("if (interactive && savedCultureInfo is null)");
