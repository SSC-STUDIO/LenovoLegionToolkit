...
Write-Host "  1. Review generated UI/resources and plugin.json metadata."
Write-Host "  2. Run: powershell -ExecutionPolicy Bypass -File .\Scripts\plugin-completion-check.ps1 -PluginIds $PluginId"
