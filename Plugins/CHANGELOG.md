...
- **Documentation polish / 文档打磨**: Rewrote root `README.md` / `README_zh-hans.md` / `CONTRIBUTING.md` to match current catalog (custom-mouse **1.0.17**, vive-tool **1.2.3**, shell-integration **1.0.13**), migrated plugins delisted from store, host **v5.0.0**, and zero mojibake.
