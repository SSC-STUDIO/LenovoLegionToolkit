...
shell_settings="右键菜单设置"
register_shell="注册 Shell"
unregister_shell="注销 Shell"
disable_win11_menu="禁用 Windows 11 菜单"
enable_win11_menu="启用 Windows 11 菜单"
force_folder_ext="强制显示文件夹扩展名"
