...
/// </summary>
[CollectionDefinition("NetworkAccelerationResourceCulture", DisableParallelization = true)]
public class NetworkAccelerationResourceCultureCollectionDefinition
{
}
