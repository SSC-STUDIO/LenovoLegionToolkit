...
public class ShellIntegrationService : IShellIntegrationService
{
    ...
    public ShellIntegrationService(ILogger<ShellIntegrationService> logger)
    {
        ...
        _shellExePath = Path.Combine(shellIntegrationDir, "shell.exe");
    ...
    public async Task<bool> InstallAsync()
    {
        try
        {
            ...
            if (!Directory.Exists(_shellIntegrationPath) || !File.Exists(_shellDllPath) || !File.Exists(_shellExePath))
            {
    ...
    public async Task<string?> GetVersionAsync()
    {
        try
        {
            ...
            return await Task.Run(() =>
            {
                var versionInfo = FileVersionInfo.GetVersionInfo(_shellExePath);
