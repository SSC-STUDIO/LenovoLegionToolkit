...
public partial class ShellIntegrationPage : Page, IPluginPage
{
    ...
    private async void InstallButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            if (success)
            {
                ShowSnackbar("Shell Integration installed successfully", "Success");
            }
            else
            {
                ShowSnackbar("Failed to install Shell Integration", "Error");
            }
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Failed to install Shell Integration");
            ShowSnackbar($"Installation failed: {ex.Message}", "Error");
    ...
    private async void UninstallButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            if (success)
            {
                ShowSnackbar("Shell Integration uninstalled successfully", "Success");
            }
            else
            {
                ShowSnackbar("Failed to uninstall Shell Integration", "Error");
            }
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Failed to uninstall Shell Integration");
            ShowSnackbar($"Uninstallation failed: {ex.Message}", "Error");
    ...
    private async void StartButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            if (success)
            {
                ShowSnackbar("Shell Integration started successfully", "Success");
            }
            else
            {
    ...
    private async void StopButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            if (success)
            {
                ShowSnackbar("Shell Integration stopped successfully", "Success");
            }
            else
            {
                ShowSnackbar("Failed to stop Shell Integration", "Error");
            }
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Failed to stop Shell Integration");
            ShowSnackbar($"Failed to stop: {ex.Message}", "Error");
