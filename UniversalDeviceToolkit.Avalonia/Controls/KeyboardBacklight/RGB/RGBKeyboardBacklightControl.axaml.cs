...
{
public partial class RGBKeyboardBacklightControl : global::UniversalDeviceToolkit.Avalonia.Controls.AbstractRefreshingControl
{
    ...
    public RGBKeyboardBacklightControl()
    {
        ...
        MessagingCenter.Subscribe<RGBKeyboardBacklightChangedMessage>(this, () => Dispatcher.UIThread.InvokeTask(async () =>
        {
            if (!IsVisible)
                return;
    ...
    protected override async Task OnRefreshAsync()
    {
        ...
        if (vantageStatus == SoftwareStatus.Enabled)
        {
            ...
            _zone1ColorPicker.IsVisible = false;
            _zone2ColorPicker.IsVisible = false;
            _zone3ColorPicker.IsVisible = false;
            _zone4ColorPicker.IsVisible = false;
        ...
        if (zonesEnabled)
        {
            ...
            _zone1ColorPicker.IsVisible = true;
            _zone2ColorPicker.IsVisible = true;
            _zone3ColorPicker.IsVisible = true;
            _zone4ColorPicker.IsVisible = true;
        }
        else
        {
            _zone1ColorPicker.IsVisible = false;
