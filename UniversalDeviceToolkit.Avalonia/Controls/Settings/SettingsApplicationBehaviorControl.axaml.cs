...
{
public partial class SettingsApplicationBehaviorControl : global::Avalonia.Controls.UserControl
{
    ...
    public async Task RefreshAsync()
    {
        ...
        if (!isCompatible)
        {
            _disableCompatibilityWarningCard.IsVisible = true;
            _disableCompatibilityWarningToggle.IsChecked = _settings.Store.DisableUnsupportedHardwareWarning;
        }
        else
        {
            _disableCompatibilityWarningCard.IsVisible = false;
        }
        ...
        _vantageCard.IsVisible = isSupportedLegionMachine && vantageStatus != SoftwareStatus.NotFound ? true : false;
        _vantageToggle.IsChecked = vantageStatus == SoftwareStatus.Disabled;

        var legionZoneStatus = await legionZoneTask;
        _legionZoneCard.IsVisible = isSupportedLegionMachine && legionZoneStatus != SoftwareStatus.NotFound ? true : false;
        _legionZoneToggle.IsChecked = legionZoneStatus == SoftwareStatus.Disabled;

        var fnKeysStatus = await fnKeysTask;
        _fnKeysCard.IsVisible = isSupportedLegionMachine && fnKeysStatus != SoftwareStatus.NotFound ? true : false;
        ...
        _osdCardControl.IsVisible = _settings.Store.EnableHardwareSensors ? true : false;
    ...
    private static async Task RunWithToggleDisabledAsync(Control toggle, Func<Task> action)
    {
    ...
    private void HardwareSensorsCard_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (_hardwareSensorsToggle.IsChecked == true)
        {
            ...
            var window = new UniversalDeviceToolkit.Avalonia.Windows.Settings.HardwareSensorSectionsWindow();
    ...
    private async void HardwareSensorsToggle_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            await RunWithToggleDisabledAsync(_hardwareSensorsToggle, async () =>
            {
                ...
                _osdCardControl.IsVisible = state.Value ? true : false;
    ...
    private async void ExportSettingsButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            // AVALONIA: WPF SaveFileDialog replaced by the StorageProvider picker API.
            ...
            _settingsBackupService.Export(fileName);
    ...
    private async void ImportSettingsButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            // AVALONIA: WPF OpenFileDialog replaced by the StorageProvider picker API.
            ...
            var fileName = files.Count > 0 ? files[0].TryGetLocalPath() : null;
            if (fileName is null)
                return;

            _settingsBackupService.Import(fileName);
