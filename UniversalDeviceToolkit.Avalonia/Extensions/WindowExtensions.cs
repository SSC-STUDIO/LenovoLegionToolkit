...
public static class WindowExtensions
{
    ...
    public static void EscalateZBand(this Window window)
    {
        ...
        try
        {
            ...
            if (GetWindowBandFn is { } getBand && getBand(handle.Handle, out uint currentBand))
            {
    ...
    /// Avalonia's property after a hidden window has been minimized to the tray.
    /// </summary>
    public static void SetTaskbarVisibility(this Window window, bool isVisible)
    {
        ...
        var extendedStyle = GetExtendedStyle(handle.Handle);
        if (isVisible)
        {
        ...
        SetExtendedStyle(handle.Handle, extendedStyle);
