...
{
public partial class OverclockDiscreteGPUSettingsWindow : global::UniversalDeviceToolkit.Avalonia.Windows.BaseWindow
{
    ...
    public OverclockDiscreteGPUSettingsWindow()
    {
        ...
        _applyCloseGrid.IsVisible = enabled ? true : false;
        _saveGrid.IsVisible = enabled ? false : true;
    ...
    private void CoreSlider_OnValueChanged(object sender, RangeBaseValueChangedEventArgs e)
        => _debouncer.Throttle(100, () => _coreLabel.Text = $"{(int)_coreSlider.Value:+0;-0;0} {MHZ}");

    private void MemorySlider_OnValueChanged(object sender, RangeBaseValueChangedEventArgs e)
        => _debouncer.Throttle(100, () => _memoryLabel.Text = $"{(int)_memorySlider.Value:+0;-0;0} {MHZ}");
    ...
    private void SetSliders(GPUOverclockInfo info)
    {
        ...
        _coreLabel.Text = $"{(int)_coreSlider.Value:+0;-0;0} {MHZ}";
        _memoryLabel.Text = $"{(int)_memorySlider.Value:+0;-0;0} {MHZ}";
    }
