...
public partial class OsdBarWindow : global::UniversalDeviceToolkit.Avalonia.Windows.Osd.OsdWindowBase
{
    ...
    protected override void ApplyAppearanceSettings()
    {
        ...
        if (_originalTextBlockStyle != null)
        {
            ...
            foreach (var setter in _originalTextBlockStyle.Setters)
    ...
    protected override void SetDefaultWindowPosition()
    {
        ...
        var screenWidth = screen.Bounds.ToRect(screen.Scaling).Width;

        Position = new PixelPoint((int)((screenWidth - actualWidth) / 2), (int)workArea.Top);
        _positionSet = true;
    }
