...
public partial class OsdSettingsWindow : global::UniversalDeviceToolkit.Avalonia.Windows.BaseWindow
{
    ...
    private void InitializeCheckboxes()
    {
        ...
        foreach (var group in groups)
        {
            var headerText = new TextBlock
            {
                ...
                FontSize = 14,
                Foreground = (IBrush)Application.Current.Resources["TextFillColorPrimaryBrush"]
            };
    ...
    private void StyleComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        try
        {
            ...
            if (_OsdSettings.Store.ShowOsd && App.Current.OsdWindow != null)
            {
                ...
                {
                    var oldOsdPos = new Point(App.Current.OsdWindow.Position.X, App.Current.OsdWindow.Position.Y);
                    ...
                    if (constructorMapping.TryGetValue(selectedStyle, out Func<Window>? constructor))
                    {
                        ...
                        App.Current.OsdWindow.Position = new PixelPoint((int)oldOsdPos.X, (int)oldOsdPos.Y);
    ...
    private void OsdCornerRadiusTopSlider_ValueChanged(object sender, RangeBaseValueChangedEventArgs e)
    {
        if (_isInitializing || !IsLoaded)
            return;
    ...
    private void OsdCornerRadiusBottomSlider_ValueChanged(object sender, RangeBaseValueChangedEventArgs e)
    {
        if (_isInitializing || !IsLoaded)
            return;
