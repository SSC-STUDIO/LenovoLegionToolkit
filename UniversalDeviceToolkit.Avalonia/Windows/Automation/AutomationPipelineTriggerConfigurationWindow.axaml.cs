...
using UniversalDeviceToolkit.Avalonia.Windows.Automation.TabItemContent;
using UniversalDeviceToolkit.Avalonia.Controls;
using UniversalDeviceToolkit.Avalonia.Extensions;

namespace UniversalDeviceToolkit.Avalonia.Windows.Automation
{
public partial class AutomationPipelineTriggerConfigurationWindow : global::UniversalDeviceToolkit.Avalonia.Windows.BaseWindow
{
    ...
    private static bool IsValid(IAutomationPipelineTrigger trigger) => trigger switch
    {
        ...
        HardwareSensorAutomationPipelineTrigger => true,
        BatteryPercentageAutomationPipelineTrigger => true,
        _ => false
    };
    ...
    private static IAutomationPipelineTriggerTabItemContent<IAutomationPipelineTrigger>? Create(IAutomationPipelineTrigger trigger) => trigger switch
    {
        ...
        HardwareSensorAutomationPipelineTrigger hs => new HardwareSensorAutomationPipelineTriggerTabItemContent(hs),
        BatteryPercentageAutomationPipelineTrigger bp => new BatteryPercentageAutomationPipelineTriggerTabItemContent(bp),
        _ => null
    };
}
}
