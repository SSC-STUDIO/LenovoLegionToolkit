...
{
public partial class WiFiConnectedPipelineTriggerTabItemContent : global::Avalonia.Controls.UserControl, IAutomationPipelineTriggerTabItemContent<IWiFiConnectedPipelineTrigger>
{
    ...
    private class ItemControl : UserControl
    {
        ...
        public ItemControl()
        {
            _removeButton.Bind(HeightProperty, new Binding(nameof(_textBox.Bounds.Height)) { Source = _textBox });
