...
{
public partial class SelectSmartKeyPipelinesWindow : global::UniversalDeviceToolkit.Avalonia.Windows.BaseWindow
{
    ...
    public SelectSmartKeyPipelinesWindow(bool isDoublePress = false)
    {
        ...
        PropertyChanged += SelectSmartKeyPipelinesWindow_PropertyChanged;
    }

    private async void SelectSmartKeyPipelinesWindow_PropertyChanged(object? sender, AvaloniaPropertyChangedEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            if (Log.Instance.IsTraceEnabled)
                Log.Instance.Trace($"Exception in {nameof(SelectSmartKeyPipelinesWindow_PropertyChanged)}.", ex);
        }
    }
