...
using System;
using ToggleSwitch = UniversalDeviceToolkit.Avalonia.Controls.ToggleSwitch;
...
public partial class HardwareSensorSectionsWindow : global::UniversalDeviceToolkit.Avalonia.Windows.BaseWindow
{
    ...
    {
        InitializeComponent();
        _orderList.ItemContainerTheme = (ControlTheme)this.FindResource("SensorSectionListItemStyle")!;
