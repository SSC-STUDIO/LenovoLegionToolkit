...
public static class Constants
{
    ...
    public const string UpdateRepositoryOwner = UniversalDeviceToolkit.Lib.Utils.AppIdentity.RepositoryOwner;
    public const string UpdateRepositoryName = UniversalDeviceToolkit.Lib.Utils.AppIdentity.RepositoryName;
